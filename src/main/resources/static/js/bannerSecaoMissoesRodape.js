document.addEventListener('DOMContentLoaded', () => {
  ...
  async function buscarBannersAtivos() {
    try {
      ...
      if (listaBanners.length === 0) {
        document.getElementById('bannerSecaoMissoesRodape').innerHTML = '<p>Nenhum anúncio disponível.</p>';
        return;
      }
  ...
  function exibirBannerAtual() {
    ...
    const container = document.getElementById('bannerSecaoMissoesRodape');
